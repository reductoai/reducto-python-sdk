...
```python
from reducto.types import JobListResponse, JobGetResponse
```

Methods:

- <code title="get /jobs">client.jobs.<a href="./src/reducto/resources/jobs.py">list</a>(\*\*<a href="src/reducto/types/job_list_params.py">params</a>) -> <a href="./src/reducto/types/job_list_response.py">JobListResponse</a></code>
- <code title="post /cancel/{job_id}">client.jobs.<a href="./src/reducto/resources/jobs.py">cancel</a>(job_id) -> object</code>
- <code title="get /job/{job_id}">client.jobs.<a href="./src/reducto/resources/jobs.py">get</a>(job_id) -> <a href="./src/reducto/types/job_get_response.py">JobGetResponse</a></code>
