...
class UploadResource(SyncAPIResource):
    ...
    def create(
        ...
        *,
        ...
        return self._post(
            "/upload",
            body=maybe_transform({"file": file}, upload_create_params.UploadCreateParams),
            options=make_request_options(
                extra_headers=extra_headers,
                extra_query=extra_query,
                extra_body=extra_body,
                timeout=timeout,
                query=maybe_transform({"extension": extension}, upload_create_params.UploadCreateParams),
            ),
    ...
    async def create(
        ...
        *,
        ...
        return await self._post(
            "/upload",
            body=await async_maybe_transform({"file": file}, upload_create_params.UploadCreateParams),
            options=make_request_options(
                extra_headers=extra_headers,
                extra_query=extra_query,
                extra_body=extra_body,
                timeout=timeout,
                query=await async_maybe_transform({"extension": extension}, upload_create_params.UploadCreateParams),
            ),
            cast_to=UploadResponse,
        )
