...
class TestSplitAsync:
    ...
    def test_method_create(self, client: Reducto) -> None:
        ...
        assert_matches_type(SplitAsyncCreateResponse, split_async, path=["response"])
    ...
    def test_raw_response_create(self, client: Reducto) -> None:
        response = client.split_async.with_raw_response.create(
            input="string",
            split_description=[
                {
                    "description": "description",
        ...
        split_async = response.parse()
        assert_matches_type(SplitAsyncCreateResponse, split_async, path=["response"])

    @pytest.mark.skip(reason="Mock server tests are disabled")
    @parametrize
    def test_streaming_response_create(self, client: Reducto) -> None:
        with client.split_async.with_streaming_response.create(
            input="string",
            split_description=[
                {
                    "description": "description",
...
class TestAsyncSplitAsync:
    ...
    async def test_method_create(self, async_client: AsyncReducto) -> None:
        split_async = await async_client.split_async.create(
            input="string",
            split_description=[
                {
                    "description": "description",
    ...
    async def test_raw_response_create(self, async_client: AsyncReducto) -> None:
        response = await async_client.split_async.with_raw_response.create(
            input="string",
            split_description=[
                {
                    "description": "description",
        ...
        assert response.is_closed is True
        assert response.http_request.headers.get("X-Stainless-Lang") == "python"
        split_async = await response.parse()
        assert_matches_type(SplitAsyncCreateResponse, split_async, path=["response"])

    @pytest.mark.skip(reason="Mock server tests are disabled")
    @parametrize
    async def test_streaming_response_create(self, async_client: AsyncReducto) -> None:
        async with async_client.split_async.with_streaming_response.create(
            input="string",
            split_description=[
                {
                    "description": "description",
